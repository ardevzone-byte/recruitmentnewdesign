 <div id="main-content">
    ...
    font-style: normal; font-size:20px;"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-right"></i></a>    تقرير ببيانات المستخدمين</h2>
                        <ul class="breadcrumb">
    ...
    font-style: normal; font-size:15px;">
                                       ...
                                       <td>
                                        <?php if ($customerss['type'] == 1) {
                                            echo "مدير إدارة";
                                        }elseif ($customerss['type'] == 2) {
                                           echo "مدير الموارد البشرية";
                                        }elseif ($customerss['type'] == 3) {
                                            echo "مدير النظام";
                                        }elseif ($customerss['type'] == 4) {
                                            echo " ";
                                        }elseif ($customerss['type'] == 5) {
                                            echo "العضو المنتدب";
                                        }elseif ($customerss['type'] == 7) {
                                            echo "مدخل بيانات";
                                        }
                                           ?></td>
