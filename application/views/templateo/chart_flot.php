...
<head>
<title>:: Lucid RTL :: Chart Flot</title>
<meta charset="utf-8">
    ...
    <nav class="navbar navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-brand">
                <a href="index.html"><img src="<?php echo base_url();?>/assets/images/logo.svg" alt="Lucid Logo" class="img-responsive logo"></a>                
            </div>
                        ...
                        <ul id="main-menu" class="metismenu">                            
                            ...
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="chart-flot.html">Flot</a> </li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Flot Chart</h2>
                        <ul class="breadcrumb">
...
<script src="<?php echo base_url();?>/assets/vendor/flot-charts/jquery.flot.time.js"></script>
