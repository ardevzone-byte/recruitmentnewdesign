        ...
        <?php echo validation_errors(); ?>
             <?php echo form_open_multipart('users/item_edit/'.$id); ?>
    <div id="main-content">
    ...
    font-style: normal; font-size:30px;"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>     تعديل بيانات الصنف</h2>
                       <ul class="breadcrumb">
    ...
    font-style: normal; font-size:15px;">الاسم</label>
                                    <input value="<?php echo $customers['name']; ?>" style="font-family: 'Tajawal', sans-serif; font-weight: bold;
   ...
   <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" value="1">   <?php if ($customers['type'] == 1) {
       echo ' مواد كهرباء ';
    ...
    <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" value="1" selected>   <?php if ($customers['unit'] == 1) {
       echo 'عدد';
       ...
       echo 'وزن';
                                    ...
                                    <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" value="1" >عدد</option>
                                    <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    ...
    font-style: normal; font-size:12px;" class="custom-select" id="inputGroupSelect01">
        ...
        <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" value="1" selected>   <?php if ($customers['status'] == 1) {
       echo 'نشط';
       ...
       echo 'غير نشط';
                                    ...
                                    <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" value="1"> نشط</option>
                                    <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    ...
    font-style: normal; font-size:12px;" type="submit" name="submitForm" value="formSave" class="btn btn-primary">تعديل</button>
                                </div>
