        ...
        <?php echo validation_errors(); ?>
            <?php echo form_open_multipart('users/send_sms10111/'.$id); ?>
    <div id="main-content">
    ...
    font-style: normal; font-size:20px;"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>              </h2>
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                           <h2 style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:20px;">         رسالة ترحيبية الى الرقم   <?php echo $get_users_otp_id_number['n2']; ?>          </h2>
                        </div>
                        <div class="body">
    ...
    font-style: normal; font-size:15px;" type="submit" name="submitForm" value="formSave" class="btn btn-primary">      ارسال رسالة نصية     </button>
