...
<?PHP if ($this ->session->userdata('type') != 4):   
    ...
    font-style: normal; font-size:15px;">
     ...
     <td><?php echo $customerss['insert_name']; ?></td> 
...
<?PHP if ($this ->session->userdata('type') == 7):   
                                      ?>
 <td >
   <a style="font-family: 'Tajawal', sans-serif; font-weight: bold; background-color:#007bff; color:#ffffff;" type="button" href="<?php echo site_url('users/view_emp_data/'.$customerss['id']); ?>" class="btn btn-outline-dark">   التفاصيل  </a></td> 
...
<?PHP if ($this ->session->userdata('type') == 2):   
 ...
 <!-- <td >
   ...
   <?PHP endif;?>
                                        ...
                                        <td > <?php  if ($customerss['state_interview']==3) {
                                           echo "لم يحضر المقتابلة";
                                        }elseif ($customerss['state_interview']==9) {
                                           echo "قائمة إنتظار";
                                        }elseif ($customerss['state_interview']==1) {
                                          echo "         إنتظار المقابلة    ";
                                        }elseif ($customerss['state_interview']==4) {
                                          echo "بإنتظار      مقابلة مدير الإدارة";
                                        }elseif ($customerss['state_interview']==2) {
                                          echo "تم إجراء المقابلة";
                                        }elseif ($customerss['state_interview']==3) {
                                          echo "لم يحضر المقابلة";
                                        }     
                                       ?>    </td>

<td > <?php  if ($customerss['useridfuturetype']==5) {
                                          echo "مرفوض";
                                        }elseif ($customerss['useridfuturetype']==6) {
                                          echo "تم القبول النهائي";
                                        }elseif ($customerss['useridfuturetype']==11) {
                                          echo "محول من العضو المنتدب الى مسؤول التوظيف";
                                        }elseif ($customerss['useridfuturetype']==4) {
                                          echo "بإنتظار تعميد العضو المنتدب";
                                        }elseif ($customerss['useridfuturetype']==2) {
                                          echo "بإنتظار تعميد مدير الموارد البشرية";
                                        }elseif ($customerss['useridfuturetype']==1) {
                                          echo "بإنتظار تعميد مدراء الإدارات";
                                        }elseif ($customerss['useridfuturetype']==3) {
                                          echo "بإنتظار تعميد    مسؤول التوظيف";
                                        }elseif ($customerss['useridfuturetype']==0) {
                                          echo "مرشحين جدد";
                                        }      
                                       ?>    </td>
...
<!-- 
                                       <td > <a title=" نموذج المقابلة الوظيفية " class="btn btn-blue btn-xs" href="https://www.sadadjobs.com/hr101/users/interview_print/<?php echo $customerss['id']; ?>" target="_blank">
