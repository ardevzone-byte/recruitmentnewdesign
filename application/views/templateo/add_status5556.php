        ...
        <?php echo validation_errors(); ?>
            <?php echo form_open_multipart('users/add_status5556/'.$id); ?>
    <div id="main-content">
    ...
    font-style: normal; font-size:20px;"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>               حالة المباشرة               
    ...
    font-style: normal; font-size:15px;">
       ...
       حالة المباشرة  </label><label style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:20px; color:#F30000;"> * </label>
                                    <br />
                                  
                                    <label class="fancy-radio">
                                        <input type="radio" name="status5" value="1" required data-parsley-errors-container="#error-radio">
                                        <span><i></i> تم المباشرة  </span>
                                    </label>
                                  
                                     <label class="fancy-radio">
                                        <input type="radio" name="status5" value="2" required data-parsley-errors-container="#error-radio">
                                        <span><i></i>  انسحاب </span>
                                    </label>
                                     <label class="fancy-radio">
                                        <input type="radio" name="status5" value="3" required data-parsley-errors-container="#error-radio">
                                        <span><i></i>  استبعاد  </span>
                                    </label>

                                      <label class="fancy-radio">
                                        <input type="radio" name="status5" value="4" required data-parsley-errors-container="#error-radio">
                                        <span><i></i>   انهاء فترة تجربة  </span>
                                    </label>
