 <div id="main-content">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2 style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;">تقرير المرسومات    حسب المشروع منذ بداية النشاط    <small><!-- <?php echo date("Y/m/d"); ?> --></small> </h2>                            
                        </div>
                        <div class="body">
    ...
    font-style: normal; font-size:15px;"> الإجمالي </th>  
                             ...
                             <tr  >
                                       <td style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;"><?php if ($customerss['project'] == 1) {
                                        echo "Al Rajhi";
                                       }else{
                                        echo "Al Ahli";
                                       }?></td> 
