        ...
        <?php echo validation_errors(); ?>
            <?php echo form_open_multipart('users/add_status22233/'.$id); ?>
    <div id="main-content">
    ...
    font-style: normal; font-size:20px;"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>             رسالة اعتذار            (<?php echo $get_id_insert_selected1010555['name']; ?>)</h2>
    ...
    font-style: normal; font-size:15px;">                     mobile number
     </p>
                                    <input  style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:20px;" type="text" name="sms" value="<?php echo $get_id_insert_selected1010555['mobile'] ?>" class="form-control" id="signin-email" value=""   autocomplete="off" readonly>
                                </div>
    ...
    font-style: normal; font-size:15px;" type="submit" name="submitForm" value="formSave" class="btn btn-primary">   send</button>
