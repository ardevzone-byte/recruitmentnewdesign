...
<div id="wrapper">
 ...
 <h2 style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    ...
    font-style: normal; font-size:15px;">  بناء على عدم موافقتك على الشروط لا يمكن استكمال بقية البيانات 
        <a type="button" href="" style="font-family: 'Tajawal', sans-serif; 
    font-style: normal; font-size:30px;" class="badge badge-warning float-right">
    ...
    font-style: normal; font-size:15px;">     نعتذر منك</span>        
                        </div>
                        <div class="progress progress-xs progress-transparent custom-color-yallow m-b-0">
