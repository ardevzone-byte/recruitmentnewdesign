        <?php echo validation_errors(); ?>
            <?php echo form_open_multipart('users/view_emp_don55/'.$id); ?>
    <div id="main-content">
   ...
   <div class="form-group">
    ...
    font-style: normal; font-size:15px;" title=" نموذج المقابلة الوظيفية " class="btn btn-blue btn-xs" href="https://www.sadadjobs.com/hr101/users/interview_print/<?php echo $customers['id_number']; ?>" target="_blank">
            ...
            <div class="form-group">
               ...
               <a style="background-color:#007bff; color:#ffffff; font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;" title="مرفق  السيرة الذاتية  " class="btn btn-download" href="#" onClick="MyWindow=window.open('<?php echo site_url(); ?>assets/imeges/posts/<?php echo $customers['cv']; ?>','MyWindow',width=50,height=50); return false;"><i class="fa fa-cloud-download" ></i>
                                                                  مرفق  السيرة الذاتية  
                                                              </a> 
   ...
   <th>         إجمالي الراتب </th>
    ...
    font-style: normal; font-size:15px;">
                                      ...
                                      ?>
                                        ...
                                        <input     type="text" name="degree_mang" class="knob2" value="<?php  $f=$customers['degree']+$customers['degree_hrs']+$customers['degree_mang'];
...
<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
    ...
    font-style: normal; font-size:25px;">       رفض العرض</h4>
            </div>
            <div class="modal-body"style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:18px;">              ما هي أسباب رفض العرض  ? </div>
           
               <?php echo form_open('/users/update_order10100117/'.$id); ?>    
              <p>
                <div class="row">
  <div class="col-md-12">
<label style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    ...
    font-style: normal; font-size:15px;"   required="required" type="text"  name="reason_of_refuse" class="form-control"></textarea>  
...
<!-- Default Size -->
<div class="modal fade" id="defaultModal19" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="defaultModalLabel"style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:25px;">          إنتظار</h4>
            </div>
           
           
               <?php echo form_open('/users/update_order10100119/'.$id); ?>    
              <p>
                <div class="row">
  <div class="col-md-12">
          ...
                     
               ...
               <!-- <input type="submit" value="نعم" class="btn btn-primary"> -->
               <button type="submit" class="btn btn-primary"style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;"> تحويل  الى قائمة انتظار</button>
                <button style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;" type="button" class="btn btn-danger" data-dismiss="modal">إلغاء</button>
