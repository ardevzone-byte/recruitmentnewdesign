        ...
        <?php echo validation_errors(); ?>
            <?php echo form_open_multipart('users/redirection/'.$id); ?>
    <div id="main-content">
    ...
    font-style: normal; font-size:20px;"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>      إعادة توجية ملف مرشح الى مدير إدارة</h2>
                       <ul class="breadcrumb">
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                           <h2 style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:20px;">               إختار مدير إدارة</h2>
                        </div>
                        <div class="body">
