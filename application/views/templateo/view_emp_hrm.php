        <?php echo validation_errors(); ?>
            <?php echo form_open_multipart('users/view_emp_hrm/'.$id); ?>
    <div id="main-content">
   ...
   <div class="form-group">
    ...
    font-style: normal; font-size:15px;" title=" نموذج المقابلة الوظيفية " class="btn btn-blue btn-xs" href="https://www.sadadjobs.com/hr101/users/interview_printf/<?php echo $customers['id_number']; ?>" target="_blank">
   ...
   <div class="form-group">
                              <a  style="background-color:#007bff; color:#ffffff; font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;" title=" نموذج المقابلة الوظيفية " class="btn btn-blue btn-xs" href="https://www.sadadjobs.com/hr101/users/interview_print/<?php echo $customers['id_number']; ?>" target="_blank">
                    نموذج المقابلة الوظيفية  
              </a>
            </div>
            ...
            <div class="form-group">
               ...
               <a style="background-color:#007bff; color:#ffffff; font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;" title="مرفق  السيرة الذاتية  " class="btn btn-download" href="#" onClick="MyWindow=window.open('https://services.marsoom.net/jobs/assets/imeges/posts/<?php echo $get_id_insert_selected5559999['cv']; ?>','MyWindow',width=50,height=50); return false;"><i class="fa fa-cloud-download" ></i>
                                                                  مرفق  السيرة الذاتية  
                                                              </a> 
 ...
 <td><?php echo $customers['qualification1']; ?></td>
  <td><?php echo $customers['specialization']; ?></td>
    ...
    font-style: normal; font-size:15px;" type="text"    class="form-control"> <?php echo $customers['note']; ?></textarea> </textarea> </td>
  ...
  <?PHP if ($this ->session->userdata('type') != 2):    ?>
   ...
   <th>         إجمالي الراتب </th>
                             ...
                             <tr  style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;">
                                       <td >        <?PHP if ($customers['degree_hrs'] != "" and $customers['degree_mang'] != "" and $customers['degree'] != ""):   
                                      ?>
  ...
  <?PHP if ($this ->session->userdata('type') == 3):   
    ...
    font-style: normal; font-size:15px;">    ملاحظات على المرشح</label>
                                   <textarea  autocomplete="off" style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;" type="text"  name="note_hrm" class="form-control"></textarea>
                                </div>

                                   <div class="form-group">
                                    <label style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;">            تعديل الراتب</label>
                                   <input  autocomplete="off" style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;" type="number"    name="expected_salary" class="form-control">
                                </div>
                                ...
                                <div class="input-group-prepend">
                                    <label style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" class="input-group-text" for="inputGroupSelect01"> تغيير المشروع</label>
                                </div>
                                <select name="The_project" style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    ...
    font-style: normal; font-size:12px;" value="<?php echo $customers['The_project']; ?>" selected>      <?php echo $customers['The_project']; ?>   </option>


      <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" value="مشروع الراجحي" >      مشروع الراجحي</option>
                                    ...
                                    <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" value=" البنك الأهلي">     البنك الأهلي</option>

<option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
      font-style: normal; font-size:12px;" value="الإدارة العامة">الإدارة العامة</option>
    ...
    font-style: normal; font-size:15px;" class="btn btn-primary js-sweetalert" data-type="success">                    موافقة وإرسال       الى   مسؤول التوظيف   </button>
...
رفض المرشح
    ...
    font-style: normal; font-size:15px;" data-toggle="modal" class="btn btn-warning" data-target="#defaultModal101">
