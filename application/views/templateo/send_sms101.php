        ...
        <?php echo validation_errors(); ?>
            <?php echo form_open_multipart('users/send_sms101/'.$id); ?>
    <div id="main-content">
    ...
    font-style: normal; font-size:15px;" type="submit" name="submitForm" value="formSave" class="btn btn-primary">  هل تريد ارسال رسالة نصية لموعد المقابلة </button>
