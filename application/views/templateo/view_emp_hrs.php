  ...
  <div class="form-group">
   ...
   حالة القبول  </label><label style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    ...
    font-style: normal; font-size:15px;" type="text"  name="n3" class="form-control">
                                 ...
                                 <div class="form-group">
                                    <label style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;">       الراتب  </label>
                                   <input   style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;" type="number"  name="salary_real" class="form-control">
                                </div>
    ...
    <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" value="مشروع البنك الاهلي" >         مشروع البنك الاهلي</option>
     ...
     <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" value="مشروع امكان">مشروع امكان</option>

    <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" value="مشروع بنك الرياض ">مشروع بنك الرياض </option>

    <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" value="مشروع مصرف الانماء ">مشروع مصرف الانماء   </option>

    <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" value="  مشروع البنك العربي ">  مشروع البنك العربي   </option>
...
<option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
 ...
 <div  style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;" style="color:#040fcf;" class="form-group">
                                        <b>الفرع</b>
                                        <div class="input-group mb-3">
                                ...
                                <select name="branch"  style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;" style="color:#040fcf;" class="custom-select" id="inputGroupSelect01">
                                    <option   value="الوسطى" selected>الوسطى</option>
 ...
 -->
  ...
  لم يحضر المقابلة
                             ...
                             <a href="#defaultModal555" style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;" data-toggle="modal" class="btn btn-danger" data-target="#defaultModal555">
