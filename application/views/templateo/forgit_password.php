...
<body class="theme-cyan rtl" style="background-repeat: no-repeat;
  background-size: 1000px 700px; background-image:url('<?php echo base_url();?>/assets/imeges/222.PNG');">
	...
	<div id="wrapper">
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle auth-main">
				<div class="auth-box">
                    <div class="top">
                        <img style="width:50px;" src="<?php echo base_url();?>/assets/imeges/logo111.PNG" alt="Lucid">
                    </div>
					<div class="card">
                        <div class="header">
