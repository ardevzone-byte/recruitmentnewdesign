        ...
        <?php echo validation_errors(); ?>
            <?php echo form_open_multipart('users/send_sms102/'.$id); ?>
    <div id="main-content">
  ...
  <div class="form-group">
    ...
    font-style: normal; font-size:15px;">     رابط المقابلة    </label><label style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    ...
    font-style: normal; font-size:15px;" type="text"  name="link" class="form-control">
                                </div>
    ...
    font-style: normal; font-size:15px;" type="submit" name="submitForm" value="formSave" class="btn btn-primary">     هل تريد ارسال رابط للمقابلة الوظيفية      </button>
