...
<!-- <button type="button" class="btn btn-danger"><i class="fa fa-trash-o"></i> <span>Danger</span></button> -->
    ...
    font-style: normal; font-size:15px;">   <!-- <i class=" icon-speedometer float-right"> -->
        <a type="button" href="" style="font-family: 'Tajawal', sans-serif; 
    font-style: normal; font-size:30px;" class="badge btn-danger float-right">
    <i class="fa fa-minus-square"></i> 
    <span>       غير مصرح لك</span>
</a> 
</i>
</h3>
                            <span style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;">  رقم الهوية المدخلة ليس لديه صلاحيات  لتسجيل  بياناته    </span>        
                        </div>
