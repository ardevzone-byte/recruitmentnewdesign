...
<div id="wrapper">
   ...
   <?php echo validation_errors(); ?>
             <?php echo form_open_multipart('users/add_interview_update/'.$id); ?>
 ...
 <div class="form-group">
    ...
    font-style: normal; font-size:15px;" type="text" value="<?php echo $customers111['n15']; ?>" pattern="[0-9]{10}" name="job_name" class="form-control">
                                </div>
    </div>
 ...
 <div class="form-group">
    ...
    font-style: normal; font-size:15px;">  الوظيفة المرشح لها</label>
                                    <input   style="background-color:#d8d7db; font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;" readonly="readonly" style="background-color:#d8d7db;" style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;" type="text" value="<?php echo $customers111['n15']; ?>" pattern="[0-9]{10}" name="job_name_detailes" class="form-control">
                                </div>
    </div>
...
<div class="row">
  <div class="col-md-8">
    ...
    font-style: normal; font-size:20px; color:#F30000;"> * </label>
                                    <input autocomplete="off" style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" type="text" name="name" value="<?php echo $customers111['name']; ?>" class="form-control" >
                                </div>
  </div>
</div>
