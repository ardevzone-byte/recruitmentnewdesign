        ...
        <?php echo validation_errors(); ?>
            <?php echo form_open_multipart('users/add_status55561225141/'.$id); ?>
    <div id="main-content">
    ...
    font-style: normal; font-size:20px;"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>                      تعديل     الرقم الوظيفي     
    ...
    font-style: normal; font-size:15px;">                   الرقم الوظيفي        
     </p>
