 <div id="main-content">
    ...
    font-style: normal; font-size:20px;"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-right"></i></a>                بناء التقارير </h2>


    <p><a class="badge badge-primary" style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;" href="<?php echo site_url('users/add_report'); ?>">                     اضافة تقرير جديد                </a><p>
    ...
    font-style: normal; font-size:15px;">  
      ...
      <td><?php echo $customerss['from_date']; ?></td>
      <td><?php echo $customerss['to_date']; ?></td>
     
 <td> 

         <p><a class="badge badge-primary" href="<?php echo site_url('users/inv1/'.$customerss['id']); ?>">   عرض التقرير          </a><p>
