...
<div class="page-loader-wrapper">
    ...
    font-style: normal; font-size:30px;">الرجاء الانتظار...</p>        
    </div>
</div>
...
<div id="wrapper">
   ...
   <?php echo validation_errors(); ?>
             <?php echo form_open_multipart('users/check_id101'); ?>
 ...
 <h2 style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    ...
    font-style: normal; font-size:15px;">رقم الهوية / الاقامة</label>
                                    <input readonly="readonly" style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;" type="text" value="<?php echo $customers11['id_number']; ?>" placeholder="10 ارقام" pattern="[0-9]{10}" name="id_number" class="form-control"required>
                                </div>
