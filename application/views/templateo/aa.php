...
<head>
<title>:: Lucid RTL :: Ui Range Sliders</title>
<meta charset="utf-8">
...
<!-- MAIN CSS -->
<link rel="stylesheet" href="<?php echo base_url();?>assets/css/main.css"><link rel="stylesheet" href="assets/css/rtl.css">
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Range Sliders</h2>
                        <ul class="breadcrumb">
...
<script src="<?php echo base_url();?>/assets/vendor/rangeslider/js/ion.rangeSlider.js"></script> <!-- RangeSlider Plugin Js --> 
<script src="<?php echo base_url();?>/assets/vendor/roundslider/roundslider.min.js"></script><!-- roundslider Plugin Js --> 

<script src="<?php echo base_url();?>assets/bundles/mainscripts.bundle.js"></script>
<script src="<?php echo base_url();?>assets/js/pages/range-sliders.js"></script> <!-- RangeSlider Plugin Js --> 
<script src="<?php echo base_url();?>/assets/vendor/material-rangeslider/mrange.js"></script> <!-- material rangeslider Js -->
<script src="<?php echo base_url();?>/assets/vendor/roundslider/custom.js"></script><!-- roundslider Plugin Js -->
</body>
</html>
