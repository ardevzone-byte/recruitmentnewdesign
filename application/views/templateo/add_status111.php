        ...
        <?php echo validation_errors(); ?>
            <?php echo form_open_multipart('users/add_status111/'.$id); ?>
    <div id="main-content">
    ...
    font-style: normal; font-size:20px;"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>                   عرض العمل   (<?php echo $get_id_insert_selected1010555['name']; ?>)</h2>
    ...
    font-style: normal; font-size:15px;">                  الراتب الأســـــــــاسي
     </p>
                                    <input  style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:20px;" type="number" name="f1" class="form-control" id="signin-email" value=""   autocomplete="off">
                                </div>


                                   <div class="form-group">
                                    <p  style="color:#F7B565; font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;">                     بـــــدل الســـكــــــــــــن
     </p>
                                    <input  style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:20px;" type="number" name="f2" class="form-control" id="signin-email" value=""   autocomplete="off">
                                </div>


                                 <div class="form-group">
                                    <p  style="color:#F7B565; font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;">                        بدل المواصلات

     </p>
                                    <input  style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:20px;" type="number" name="f3" class="form-control" id="signin-email" value=""   autocomplete="off">
                                </div>
                                 ...
                                 <div class="form-group">
                                    <p  style="color:#F7B565; font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;">                           بدل اتصالات وانترنت


     </p>
                                    <input  style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:20px;" type="number" name="f4" class="form-control" id="signin-email" value=""   autocomplete="off">
                                </div>
    ...
    font-style: normal; font-size:15px;">     تاريخ المباشرة   </label><label style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:20px; color:#F30000;"> * </label>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                            </div>
                                             <input autocomplete="off" required required name="f5" data-provide="datepicker" data-date-autoclose="true" class="form-control" data-date-format="yyyy/mm/dd">
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group">
                                    <p  style="color:#F7B565; font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;">        الفرع                        


     </p>
                                    <input  style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:20px;" type="text" name="bransh" class="form-control" id="signin-email" value=""   autocomplete="off">
                                </div>
