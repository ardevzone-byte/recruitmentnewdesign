...
<div id="wrapper">
   ...
   <?php echo validation_errors(); ?>
             <?php echo form_open_multipart('users/add_att7/'.$id); ?>
...
<span class="fa-stack">
...
</span>                         الموافقة على طلب الأدلة الجنائية
 </label>
    ...
    font-style: normal; font-size:12px;" type="submit" name="submitForm" value="formSave" class="btn btn-primary"> تم</button>
    <button style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" type="submit" name="submitForm" value="formSaveNew" class="btn btn-primary">     لم يتم</button>
