        ...
        <?php echo validation_errors(); ?>
            <?php echo form_open_multipart('users/state_interview/'.$id); ?>
    <div id="main-content">
    ...
    font-style: normal; font-size:20px;"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>       اضافة موعد للمقابلة الشخصية</h2>
                       <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo base_url();?>users/dashbord_analyses102"><i class="icon-home"></i></a></li>                            
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                           <h2 style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:20px;">                   حالة المقابلة</h2>
                        </div>
                        <div class="body">
    ...
    font-style: normal; font-size:15px;" style="color:#040fcf;" class="form-group">
                                        <b>حالة المقابلة</b><label style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:20px; color:#F30000;"> * </label>
                                ...
                                <select name="state_interview"  style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;" style="color:#040fcf;" class="custom-select" id="inputGroupSelect01">

      <option   value="9" selected>       قائمة إنتظار</option>

                                  <option   value="1" > انتظار المقابلة</option>
                                    <option   value="2">تم اجراء المقابلة</option>
                                    <option   value="3">لم يحضر المقابلة</option>
                                      <option   value="4">انتظار مقابلة مدير الإدارة</option>
