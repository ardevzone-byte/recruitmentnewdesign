        ...
        <?php echo validation_errors(); ?>
            <?php echo form_open_multipart('users/order_edit/'.$id); ?>
    <div id="main-content">
    ...
    font-style: normal; font-size:20px;"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> تعديل الطلب</h2>
                       <ul class="breadcrumb">
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                           <h2 style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:20px;">          تعديل بيانات الطلب</h2>
                        </div>
                        <div class="body">
                            <form id="basic-form" method="post" novalidate >
                                <div class="form-group">
                                    <label style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;">   الصنف</label>
                                     <select style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;"  name="item_name" class="form-control">
                    <?php foreach($get_items101 as $get_items101): ?>
                           <option <?php if( $get_items101['name']==$get_items_selected['item_name']){echo 'selected=select';}?> value="<?php echo $get_items101['name']; ?>"><?php echo $get_items101['name']; ?></option>
                    ...
                    <?php endforeach; ?>
                                 ...
                                 <div class="form-group">
                                    <label style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;">   الكمية</label>
                                     <input style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;" type="text" name="quantity" value="<?php echo $get_items_selected['quantity'];?>" class="form-control" required>
                                </div> 

                                <div class="form-group">
                                    <label style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;">    السعر</label>
                                     <input style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;" type="text" name="price" value="<?php echo $get_items_selected['price'];?>" class="form-control" required>
                                </div> 
    ...
    font-style: normal; font-size:15px;" type="submit" name="submitForm" value="formSave" class="btn btn-primary">تعديل</button>
     ...
     <button type="button" data-toggle="modal" data-target="#staticModal" class="btn btn-danger" title="حذف"><span class="sr-only">حذف</span> <?php $id3=$get_items_selected['id']; ?><i class="fa fa-trash-o"></i></button>
  ...
  <div class="col-md-6">
                <?php echo form_open('/users/delete_detailes_order/'.$id3); ?>    
              <p>
