        ...
        <?php echo validation_errors(); ?>
            <?php echo form_open_multipart('users/add_status/'.$id); ?>
    <div id="main-content">
    ...
    font-style: normal; font-size:20px;"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>              تغيير حالة المرشح</h2>
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                           <h2 style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:20px;">                   الحالة</h2>
                        </div>
                        <div class="body">
    ...
    font-style: normal; font-size:12px;" value="7" >مقابلة عن بعد</option>
                                    <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" value="10">مرفوض</option>
      <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" value="8">لم يتم الرد</option>
    ...
    font-style: normal; font-size:15px;">                 ملاحظة     </p>
                                    <input  style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:20px;" type="text" name="note" class="form-control" id="signin-email" value=""   autocomplete="off">
                                </div>
