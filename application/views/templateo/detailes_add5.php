<?php echo validation_errors();  echo form_open_multipart('users/detailes_add5/'.$id); ?>
<style>
#cal-1, #cal-2 {
  margin-left: 12px;
  margin-top: 10px;
...
<div class="row">
	<div class="col-md-4">
	<label class="col-sm-6 control-label">مرفق    </label>
	
		<div class="form-group"> 
			<input type="file" name="userfile[]" id="files" multiple="multiple"  class="form-control" required> 
		</div>
		...
		<input type="submit" name="Save" id="Save" class="btn btn-primary" value="اضافة المرفق" />  
	</br>
	</br>
