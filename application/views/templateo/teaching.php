...
<div id="wrapper">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                             ...
                             <div class="col-md-6">
                                     ...
                                     <img style="width:60px;" src="<?php echo base_url();?>/assets/imeges/marsoom.PNG"   alt="Lucid" >    
                            </div>
 ...
 <h2 style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    ...
    font-style: normal; font-size:15px;"> الاخ   : <?php echo $customers['name']; ?> <!-- <i class="icon-basket float-right"> --><a style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:30px;" type="button" href="" class="badge btn btn-outline-primary float-right" disabled="disabled"><i class="fa fa-spinner fa-spin"></i> <span>   قيد الدراسة</span></a></i></h3>
                            <span style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:15px;">        تم تسجيل بيانات مسبقاً  </span>                            
                        </div>
