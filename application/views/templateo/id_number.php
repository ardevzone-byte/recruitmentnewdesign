 <div id="main-content">
    ...
    font-style: normal; font-size:20px;"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-right"></i></a>     تقرير ببيانات  هويات المرشحين للتوظيف</h2>
                        <ul class="breadcrumb">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2 style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:20px;">بيانات   هويات المرشحين للتوظيف<small><!-- All Users In insert_sadad --></small> </h2>                            
                        </div>
                        <div class="body">
    ...
    font-style: normal; font-size:15px;">
                               ...
                               <th>رقم الهوية </th>
                               <th>الجنس</th>
                               <th>نوع الوظيفة المقدم عليها</th>
    ...
    font-style: normal; font-size:15px;">
                                       ...
                                       <td><?php echo $customerss['sex']; ?></td>
                                       <td><?php echo $customerss['job_name']; ?></td>
                                        <td><?php echo $customerss['job_name_detailes']; ?></td>

                                        <td>  <a type="button" href="<?php echo site_url('users/id_edit/'.$customerss['id']); ?>" class="btn btn-outline-dark">تعديل</a></td>
