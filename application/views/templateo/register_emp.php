        ...
        <?php echo validation_errors(); ?>
             <?php echo form_open_multipart('users/register_emp'); ?>
    <div id="main-content">
    ...
    font-style: normal; font-size:30px;"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> الرجاء تعبئة النموذج ادناه</h2>
                       <ul class="breadcrumb">
    ...
    font-style: normal; font-size:12px;" value="1" selected>   مقدم الطلب</option>
                                    <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" value="2"> الدراسة  </option>
                                    <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" value="3"> التعميد  </option>
     <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
    font-style: normal; font-size:12px;" value="4">  المالية  </option>
     <option style="font-family: 'Tajawal', sans-serif; font-weight: bold;
