 <div id="main-content">
    ...
    font-style: normal; font-size:20px;"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-right"></i></a>                    <button style="font-family: 'Tajawal', sans-serif; font-weight: bold; background-color:#007bff; color:#ffffff;" type="button" class="btn btn-primary" disabled="disabled"><i class="fa fa-refresh fa-spin"></i> <span>     انتظار مقابلة مدير الإدارة</span></button></h2>
                        <ul class="breadcrumb">
...
<!-- 
                                       ...
                                       <td><?php echo $customerss['Nationality']; ?></td>
                                          <td><?php echo $customerss['Date_of_the_personal_interview']; ?> - <?php echo $customerss['Time_of_the_interview']; ?></td>
   ...
   <?PHP if ($this ->session->userdata('type') == 3):   
                                    ...
                                    <!--   <td >
                                      ...
                                      <button style="font-family: 'Tajawal', sans-serif; font-weight: bold; background-color:#007bff; color:#ffffff;" type="button" class="btn btn-primary" disabled="disabled"><i class="fa fa-refresh fa-spin"></i> <span>  انتظار المقابلة</span></button>
                                       ...
                                       <?PHP elseif ($customerss['state_interview'] == 4):   
                                      ?>
                                       <button style="font-family: 'Tajawal', sans-serif; font-weight: bold; background-color:#007bff; color:#ffffff;" type="button" class="btn btn-primary" disabled="disabled"><i class="fa fa-refresh fa-spin"></i> <span>     انتظار مقابلة مدير الإدارة</span></button>
