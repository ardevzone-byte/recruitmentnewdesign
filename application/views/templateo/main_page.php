...
<body>
    ...
    <div class="top-fixed-nav">
        ...
        <button class="btn btn-secondary" onclick="location.href='<?= site_url('users/logout'); ?>'">
    ...
    <div class="main-screen-container position-relative">
        ...
        <h2 class="text-center mb-5">لوحة متابعة التوظيف</h2>

        <div class="quick-actions-grid">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
                
                <div class="col">
                    <a href="<?php echo site_url('users/dashbord_analyses102#Home-new2'); ?>" class="quick-action-button">
                ...
                <div class="col">
                    <a href="<?php echo site_url('users/dashbord_analyses102#Profile-new2'); ?>" class="quick-action-button">
                        <i class="fas fa-clipboard-question"></i>
                        <span>حالات المقابلات</span>
                    </a>
                </div>

                <?php 
                  // Note: This logic seems to be from another file, ensure $allowed_users_letter is defined
                  // $username = $this->session->userdata('username'); 
                  // if(in_array($username, $allowed_users_letter)): 
                ?>
                <div class="col">
                    <a href="<?php echo site_url('users/candidates_dashboard'); ?>" class="quick-action-button">
                 ...
                 <div class="col">
                    <a href="<?php echo site_url('users/dashbord_analyses102#Profile-new2'); ?>" class="quick-action-button">
                        <i class="fas fa-clipboard-question"></i>
                        <span>مصادر السيرة الذاتية </span>
                    </a>
                </div>
                <?php // endif; ?>

                <div class="col">
                      <a href="<?php echo site_url('users/user_report101'); ?>" class="quick-action-button" target="_blank" rel="noopener noreferrer">
    ...
    <script>
      // This script is for the 'btnNotifications' which exists in your nav
      // If you intended the "الإشعارات" button to show the toast, give it id="btnNotifications"
